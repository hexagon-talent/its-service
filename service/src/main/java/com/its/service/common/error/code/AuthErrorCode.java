...
public enum AuthErrorCode implements ErrorCode{
    ...
    REFRESH_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-011", "쿠키에 refreshToken 이 없습니다."),
    ACCESS_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-012", "요청 헤더에 accessToken 이 없습니다."),
    // 권한 애러
    USER_NOT_EXIST(HttpStatus.UNAUTHORIZED, "AUTH_013", "가입한 사용자가 존재하지 않습니다.");
